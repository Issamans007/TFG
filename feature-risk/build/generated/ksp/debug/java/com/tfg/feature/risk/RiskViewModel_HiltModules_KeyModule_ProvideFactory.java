...
public final class RiskViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  ...
  public static boolean provide() {
    return RiskViewModel_HiltModules.KeyModule.provide();
  }

  private static final class InstanceHolder {
    private static final RiskViewModel_HiltModules_KeyModule_ProvideFactory INSTANCE = new RiskViewModel_HiltModules_KeyModule_ProvideFactory();
  }
}
